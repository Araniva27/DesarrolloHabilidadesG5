...
namespace MVCPelicula.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        // GET: Peliculas
        public async Task<IActionResult> Index(string textoBuscar)
        {
            ...
            {
                peliculas = peliculas.Where(p => p.Titulo.Contains(textoBuscar));
            }
        ...
        [HttpPost]
        public string Index(string textoBuscar, bool notUsed)
        {
            return "From [HttpPost]Index: filter on " + textoBuscar;
        }
    }
}
